...
final String avatar;
  ...
  UserWithComment(this.username, this.comment,this.avatar);
}
...
List avatars = ["assets/avatar2.png","assets/avatar3.png","assets/avatar4.png","assets/avatar5.png",
"assets/avatar6.png","assets/avatar7.png"];
